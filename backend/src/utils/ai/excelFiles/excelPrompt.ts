...
## Schema to map to:
{
  ...
  "product_quantity": "matching_column_number_from_excel_header", 
  "total_amount": "matching_column_number_from_excel_header", 
  "invoice_date": "matching_column_number_from_excel_header", 
  "product_name": "matching_column_number_from_excel_header", 
